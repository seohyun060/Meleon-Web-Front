...
import IllustratorRecommendPage from '../components/IllustratorRecommendPage';

const IllustratorRecommendPageContainer = () => {
...
export default IllustratorRecommendPageContainer;
