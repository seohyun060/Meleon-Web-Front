...
const coinHistoryDummy: CoinHistoryItemType[] = [
  {
    date: '2022-01-12',
    img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPhqMIyeoinp6cTPRc1_WhbeRgbF7LCxnKgQ&usqp=CAU',
    detail: 'SF판타지 배경',
    usedCoin: 1200,
    remainCoin: 2500,
  },
  {
    date: '2022-01-12',
    img: 'https://celcliptipsprod.s3-ap-northeast-1.amazonaws.com/tips_article_body/2139/1970635/1b100c14b0fc519767d4428da931ebf8',
    detail: '고혹적인 캐릭터 일러스트',
    usedCoin: 1200,
    remainCoin: 2500,
  },
  {
  ...
  {
    date: '2022-01-12',
    img: 'https://cdn.ilovepcbang.com/news/photo/202106/83164_123389_5832.jpg',
    detail: 'Maze on structure',
    usedCoin: 1200,
    remainCoin: 2500,
  },
  {
  ...
  {
    date: '2022-01-12',
    img: 'https://cdn1.epicgames.com/ue/product/Screenshot/1-1920x1080-f456eb95f04da6b4d14d9bc8ec77fe4a.jpg?resize=1&w=1920',
    detail: 'mechanical image assets',
    usedCoin: 1200,
    remainCoin: 2500,
  },
  {
...
const PaymentContainer = (props: Props) => {
  ...
  const [historyList, setHistoryList] = useState(coinHistoryDummy);
  ...
  const shuffle = useCallback<<T>(list: T[]) => T[]>((list) => {
    ...
    for (let index = clone.length - 1; index > 0; index--) {
      ...
      clone[index] = clone[randomPosition];
      clone[randomPosition] = temporary;
    }
    return clone;
  }, []);
  ...
  const onApplyButtonClicked = useCallback(() => {
    setHistoryList((prev) => shuffle(prev));
  }, [shuffle]);
