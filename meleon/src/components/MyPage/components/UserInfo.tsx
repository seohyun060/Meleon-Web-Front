...
const UserInfo = ({ onBenefitClicked, onLogoutClicked }: Props) => {
  return (
    <section className='user-info-root'>
      <div className='wrapper'>
        <div className='profile-container'>
          <div className='col'>
            <img className='user-img' src={user.img} alt='img_user' />
          </div>
          <div className='col'>
            <div className='row'>
        ...
        <div className='coin-progress'>
          <span className='text'>
            1,000 코인 더 사용 시 <span className='colored'>2등급 달성!</span>
          </span>
